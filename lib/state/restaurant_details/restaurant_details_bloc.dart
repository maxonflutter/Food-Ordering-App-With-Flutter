...
class RestaurantDetailsBloc
  ...
  RestaurantDetailsBloc({
    ...
    on<LoadRestaurantDetailsEvent>(_onLoadHome);
  }
  ...
  void _onLoadHome(
    ...
    try {
      final restaurantFuture = _restaurantRepository.fetchRestaurant(
        restaurantId: event.restaurantId,
      );

      final response = await Future.wait([restaurantFuture]);
      final restaurant = response[0] as Restaurant;
